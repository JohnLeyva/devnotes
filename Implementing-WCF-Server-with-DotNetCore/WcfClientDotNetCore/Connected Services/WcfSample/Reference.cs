...
namespace WcfSample
{
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    [System.ServiceModel.ServiceContractAttribute(ConfigurationName="WcfSample.IEchoService")]
    public interface IEchoService
    {
        ...
        System.Threading.Tasks.Task<string> ComplexEchoAsync(WcfSample.EchoMessage text);
        ...
        [System.ServiceModel.FaultContractAttribute(typeof(WcfSample.EchoFault), Action="http://tempuri.org/IEchoService/FailEchoEchoFaultFault", Name="EchoFault", Namespace="http://schemas.datacontract.org/2004/07/Contract")]
        System.Threading.Tasks.Task<string> FailEchoAsync(string text);
    }
    
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public interface IEchoServiceChannel : WcfSample.IEchoService, System.ServiceModel.IClientChannel
    {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("Microsoft.Tools.ServiceModel.Svcutil", "2.0.3")]
    public partial class EchoServiceClient : System.ServiceModel.ClientBase<WcfSample.IEchoService>, WcfSample.IEchoService
    {
        ...
        public System.Threading.Tasks.Task<string> ComplexEchoAsync(WcfSample.EchoMessage text)
        {
        ...
        {
            if ((endpointConfiguration == EndpointConfiguration.NetTcpBinding_IEchoService))
            {
        ...
        private static System.ServiceModel.EndpointAddress GetEndpointAddress(EndpointConfiguration endpointConfiguration)
        {
            if ((endpointConfiguration == EndpointConfiguration.NetTcpBinding_IEchoService))
            {
                return new System.ServiceModel.EndpointAddress("net.tcp://localhost:8089/");
            }
            if ((endpointConfiguration == EndpointConfiguration.BasicHttpBinding_IEchoService))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:8088/basic");
            }
            if ((endpointConfiguration == EndpointConfiguration.WSHttpBinding_IEchoService))
            {
                return new System.ServiceModel.EndpointAddress("http://localhost:8088/wshttp");
            }
            throw new System.InvalidOperationException(string.Format("Could not find endpoint with name \'{0}\'.", endpointConfiguration));
        }
